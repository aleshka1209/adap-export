...
if (!isset($_POST['category']) && !isset($_POST['subcategory'])) {
    ...
    echo '<button class="btn-more btn header__link" data-category="zernovye">More details</button>';
    echo '</div>';
    echo "</div><hr>";
    ...
    echo '<div class="products__info">';
    echo '<h3>Oilseeds</h3>';
    echo "<p class='products__text'>Oil crops are plants cultivated to produce fatty oils. They include annual and perennial plants of various families: Asteraceae - sunflower, safflower; legumes - soybeans,...</p>";
    echo '<button class="btn-more btn header__link" data-category="zernovye">More details</button>';
    echo '</div>';
    echo "</div><hr>";
    ...
    echo '<div class="products__info">';
    echo '<h3>Legumes</h3>';
    echo "<p class='products__text'>Legumes (grain legumes, in cooking - just legumes) - a group of some plants of the order Legumes, cultivated for their fruits, which are food products. Legumes are used...</p>";
    echo '<button class="btn-more btn header__link" data-category="zernovye">More details</button>';
    echo '</div>';
    ...
    if ($category == 'zernovye') {
        ...
        echo '<div class="products__info">';
        echo '<h3>Wheat</h3>';
        echo "<p>Wheat is the main grain crop. Based on the timing of sowing, it is divided into spring and winter. Depending on the botanical characteristics, it is divided into the main types - soft and hard. Soft wheat...</p>";
        echo '<button class="btn-more btn header__link" data-category="zernovye" data-subcategory="pshenica">More details</button>';
        echo '</div>';
        echo '</div>';
        echo '<hr>';
        ...
        echo '<div class="products__info">';
        echo '<h3>Barley</h3>';
        echo "<p>Barley is a fast-ripening (the growing season lasts 70 days) spring crop that grows everywhere. It is divided into six-row and two-row. Pearl barley and barley are produced from barley...</p>";
        echo '<button class="btn-more btn header__link" data-category="zernovye" data-subcategory="yachmen">More details</button>';
        echo '</div>';
        echo '</div>';
        echo '<hr>';
        ...
        echo '<div class="products__info">';
        echo '<h3>Corn</h3>';
        echo "<p>Corn according to the shape, structure of the cob and grain is divided into flint, tooth-shaped, semi-tooth-shaped, sugar, filmy, starchy, waxy, popping, etc. Contains less than ...</p>";
        echo '<button class="btn-more btn header__link" data-category="zernovye" data-subcategory="kukuruza">More details</button>';
        echo '</div>';
        echo '</div>';
        echo '<hr>';
        ...
        echo "<p>Buckwheat has a triangular fruit, covered not with floral films, like cereals, but with a dense fruit shell, under which there is a core consisting of a seed coat, aleurone layer...</p>";
        echo '<button class="btn-more btn header__link" data-category="zernovye" data-subcategory="buckwheat">More details</button>';
        echo '</div>';
        echo '</div>';
        ...
        echo '<button class="btn-more btn header__link" data-category="maslichnye" data-subcategory="podsolnechnik">More details</button>';
        echo '</div>';
        echo '</div>';
        echo '<hr>';
        ...
        echo '<button class="btn-more btn header__link" data-category="maslichnye" data-subcategory="raps">More details</button>';
        echo '</div>';
        echo '</div>';
        echo '<hr>';
        ...
        echo '<div class="products__info">';
        echo '<h3>Len</h3>';
        echo "<p>The oil content of flax seeds is 42...44%, they contain up to 23% protein. Oil is produced from the seeds, which is used mainly for technical purposes. Its ability to quickly ...</p>";
        echo '<button class="btn-more btn header__link" data-category="maslichnye" data-subcategory="len">More details</button>';
        echo '</div>';
        echo '</div>';
        ...
        echo '<div class="products__info">';
        echo '<h3>Peas</h3>';
        echo "<p>Peas come from Afghanistan and Eastern India. The fruit of the pea - the bean - consists of valves and seeds. Based on the structure of the valves of the beans, pea varieties are divided into sugar and shelling. Sakha beans...</p>";
        echo '<button class="btn-more btn header__link" data-category="bobovye" data-subcategory="goroh">More details</button>';
        echo '</div>';
        echo '</div>';
        echo '<hr>';
        ...
        echo '<div class="products__info">';
        echo '<h3>Soy</h3>';
        echo "<p>Soybean is a universal world legume crop. Flour, butter, milk, cheese are obtained from soybean; it is added to confectionery, canned food, sauces and other food products. Soybean is used only ...</p>";
        echo '<button class="btn-more btn header__link" data-category="bobovye" data-subcategory="soya">More details</button>';
        echo '</div>';
        echo '</div>';
    ...
    if ($subcategory == 'pshenica') {
        ...
        echo '<hr>';
        echo '<br>';
        echo "<p>Wheat is the main grain crop. Based on the timing of sowing, it is divided into spring and winter. Depending on the botanical characteristics, it is divided into the main types - soft and hard</p>";

        echo "<p>Soft wheat has a grain of glassy, ​​semi-vitreous or mealy consistency, round or oval in shape, slightly expanded towards the germ, with a pronounced beard and deep groove. The color of the grain can be white, red or yellow. Soft wheat is used in confectionery and baking productions.</p>";

        echo "<p>Durum wheat is significantly different from soft wheat. The grain is more elongated with a thickening on the back at the embryo, ribbed, glassy when cut, translucent, the beard is poorly developed, the groove is open, shallowly entering the grain. Color from light to dark - amber. It contains more protein, sugar and minerals than bread wheat. Durum wheat is used for the production of pasta, semolina, added when grinding wheat with low baking properties, to obtain semolina flour.</p>";
        ...
        echo '
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Mass fraction of protein, % on dry matter, not less</td>
                        <td>13.5</td>
                        <td>12.5</td>
                        <td>11.5</td>
                        <td>9.5</td>
                    ...
                    <tr>
                        <td>Mass fraction of raw gluten, %, not less</td>
                        <td>28</td>
                        <td>25</td>
                        <td>23</td>
                        <td>18</td>
                    ...
                    <tr>
                        <td>Number of falls, s, not less</td>
                        <td>200</td>
                        <td>200</td>
                        <td>200</td>
                        <td>80</td>
