...
if (!isset($_POST['category']) && !isset($_POST['subcategory'])) {
    ...
    echo '<button class="btn-more btn header__link" data-category="zernovye">Подробнее</button>';
    echo '</div>';
    echo "</div><hr>";
    ...
    if ($category == 'zernovye') {
        ...
        echo '<div class="products__info">';
            ...
            echo '<button class="btn-more btn header__link" data-category="zernovye" data-subcategory="pshenica">Подробнее</button>';
        echo '</div>';
        echo '</div>';
        echo '<hr>';
        ...
        echo '<div class="products__info">';
            ...
            echo '<button class="btn-more btn header__link" data-category="zernovye" data-subcategory="yachmen">Подробнее</button>';
        echo '</div>';
        echo '</div>';
        echo '<hr>';
        ...
        echo '<div class="products__info">';
            ...
            echo '<button class="btn-more btn header__link" data-category="zernovye" data-subcategory="kukuruza">Подробнее</button>';
        echo '</div>';
        echo '</div>';
        echo '<hr>';
        ...
        echo '<div class="products__info">';
            ...
            echo '<button class="btn-more btn header__link" data-category="zernovye" data-subcategory="buckwheat">Подробнее</button>';
        echo '</div>';
        echo '</div>';
        ...
        echo '<div class="products__info">';
            ...
            echo '<button class="btn-more btn header__link" data-category="maslichnye" data-subcategory="podsolnechnik">Подробнее</button>';
        echo '</div>';
        echo '</div>';
        echo '<hr>';
        ...
        echo '<div class="products__info">';
            ...
            echo '<button class="btn-more btn header__link" data-category="maslichnye" data-subcategory="raps">Подробнее</button>';
        echo '</div>';
        echo '</div>';
        echo '<hr>';
        ...
        echo '<div class="products__info">';
            ...
            echo '<button class="btn-more btn header__link" data-category="maslichnye" data-subcategory="len">Подробнее</button>';
        echo '</div>';
        echo '</div>';
        ...
        echo '<div class="products__info">';
            ...
            echo '<button class="btn-more btn header__link" data-category="bobovye" data-subcategory="goroh">Подробнее</button>';
        echo '</div>';
        echo '</div>';
        echo '<hr>';
        ...
        echo '<div class="products__info">';
            ...
            echo '<button class="btn-more btn header__link" data-category="bobovye" data-subcategory="soya">Подробнее</button>';
        echo '</div>';
        echo '</div>';
        ...
        echo '
            <table class="table-fix">
                ...
                <tbody>
                    <tr>
                        <td>Цвет</td>
                        <td colspan="4">Кремовый сжелтоватым или зеленоватым оттенком; <br>
                        для быстроразвариваюшейся крупы –коричневый разных оттенков</td>
                    </tr>
                    <tr>
                        <td>Запах</td>
                        <td colspan="4">Свойственныйгречневой крупе, <br>
                        без посторонних запахов, не затхлый, не плесневелый</td>
                    </tr>
                    <tr>
                        <td>Вкус</td>
                        <td colspan="4">Свойственныйгречневой крупе, <br>
                        без посторонних привкусов, не кислый, не горький</td>
                    </tr>
                    <tr>
                        <td>Влажность,%,не более</td>
